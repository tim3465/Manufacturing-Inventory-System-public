...
public interface IMachineRepository
{
    ...
    Task<List<Machine>> ListActiveAsync(CancellationToken ct = default);
    Task<List<Machine>> ListAllAsync(CancellationToken ct = default);
    Task<List<Machine>> ListActiveWithJobsAsync(CancellationToken ct = default);
