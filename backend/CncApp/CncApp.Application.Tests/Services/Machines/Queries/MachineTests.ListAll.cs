...
{
    [Fact]
    public async Task ListAllAsync_WhenMachinesExist_ReturnsListOfMachineDtos()
    {
        // Arrange
        ...
        // Act
        var result = await MachineService.ListAllAsync(cancellationToken);
    ...
    [Fact]
    public async Task ListAllAsync_WhenNoMachinesExist_ReturnsEmptyList()
    {
        // Arrange
        var cancellationToken = CancellationToken.None;
        var machines = new List<Machine>();
