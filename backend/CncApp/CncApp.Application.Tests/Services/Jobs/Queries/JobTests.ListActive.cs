...
{
    [Fact]
    public async Task ListActiveAsync_WhenJobsExist_ReturnsListOfJobDtos()
    {
        // Arrange
        ...
        // Act
        var result = await JobService.ListActiveAsync(cancellationToken);
    ...
    [Fact]
    public async Task ListActiveAsync_WhenNoJobsExist_ReturnsEmptyList()
    {
        // Arrange
        var cancellationToken = CancellationToken.None;
        var jobs = new List<Job>();
