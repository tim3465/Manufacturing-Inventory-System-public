...
{
    [Fact]
    public async Task ListActiveAsync_WhenPartsExist_ReturnsListOfPartDtos()
    {
        // Arrange
        ...
        // Act
        var result = await PartService.ListActiveAsync(cancellationToken);
    ...
    [Fact]
    public async Task ListActiveAsync_WhenNoPartsExist_ReturnsEmptyList()
    {
        // Arrange
        var cancellationToken = CancellationToken.None;
        var parts = new List<Part>();
