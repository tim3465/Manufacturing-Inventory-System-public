...
{
    [Fact]
    public async Task ListActiveAsync_WhenCustomersExist_ReturnsListOfCustomerDtos()
    {
        // Arrange
        ...
        // Act
        var result = await CustomerService.ListActiveAsync(cancellationToken);
    ...
    [Fact]
    public async Task ListActiveAsync_WhenNoCustomersExist_ReturnsEmptyList()
    {
        // Arrange
        var cancellationToken = CancellationToken.None;
        var customers = new List<Customer>();
