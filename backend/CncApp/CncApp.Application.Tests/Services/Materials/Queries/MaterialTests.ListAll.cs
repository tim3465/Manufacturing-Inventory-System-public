...
{
    [Fact]
    public async Task ListAllAsync_WhenMaterialsExist_ReturnsListOfMaterialDtos()
    {
        // Arrange
        ...
        var materials = new List<Material>
        {
            ...
            new Material("HN789012", "Steel-B2") { Id = 2, InactivatedDateTime = DateTimeOffset.UtcNow }
        };
        ...
        // Act
        var result = await MaterialService.ListAllAsync(cancellationToken);
    ...
    [Fact]
    public async Task ListAllAsync_WhenNoMaterialsExist_ReturnsEmptyList()
    {
        // Arrange
        var cancellationToken = CancellationToken.None;
        var materials = new List<Material>();
